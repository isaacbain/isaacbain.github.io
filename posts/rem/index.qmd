...
Fortunately, the [RiverREM](https://github.com/OpenTopography/RiverREM) Python package takes care of most of the heavy lifting. The package is designed specifically for creating REMs of river systems and streamlining the process for researchers and practitioners.
...
Remember that in a REM, every height is by definition relative to the river centreline. And apologies for the blocky outline of the below images! This is due to the outline of the captured LiDAR imagery.
...
Interestingly, this is also where the kayak leg of the Coast to Coast race concludes, making it a notable point both geographically and recreationally!
...
Just downstream of Courtenay, the riverbed becomes noticeably shallower, a feature clearly indicated by the relatively darker colour in the main riverbed on the REM. This section highlights the natural variability in the river’s depth. Additionally, you can observe the flood defences on the southern side of the river, strategically placed to prevent the river from spilling over onto the Old West Coast Road.
...
In this section, the extensive flood engineering works are clearly visible, particularly in the form of stop-banks and groynes. These hard engineering structures are designed to control the river’s flow, manage sediment deposition, and protect surrounding areas from flooding. While highly effective in preventing immediate flood risks, they exemplify the traditional approach of hard engineering, which often requires significant maintenance and can alter the natural dynamics of the river.

There is growing interest in complementing these hard engineering with nature-based solutions. Integrating natural floodplains or re-establishing vegetation could enhance a river’s natural ability to manage floodwaters, offering a more sustainable and resilient approach to flood management in the long term. Combining these methods could provide the necessary protection while also supporting the river’s ecological health.
...
Here you can explore the Waimakariri REM. Zoom in and pan around to see the detailed elevation changes and how these structures interact with the landscape.

Due to file size restrictions, the map has been downsampled to approximately 15MB, which lowers the resolution of the data versus the above cropped images.
