...
3D printers are widely available and can be purchased for a few hundred dollars. If you prefer not to buy one, many libraries, schools, and makerspaces offer 3D printing services for a small fee. Additionally, commercial services are available to print your models for you.
...
For sea-draining catchments in New Zealand, the Ministry for the Environment offers a dataset of sea-draining catchment boundaries[^1] available for download.

[^1]: <https://data.mfe.govt.nz/layer/99776-sea-draining-catchments/>
...
To add the estuary itself, you can use NIWA's Estuarine Environment Classification dataset[^2], which includes the boundaries of most estuaries in New Zealand. Or LINZ topographic maps are a good source too.

[^2]: <https://www.doc.govt.nz/nature/habitats/estuaries/estuaries-spatial-database>

#### Elevation data

For elevation data, LINZ provides high-resolution LiDAR data[^3] that is increasingly available for New Zealand. This data is essential for creating a detailed 3D model of your catchment, especially for small catchments where detail is crucial. For larger catchments, lower resolution satellite DEMs may suffice and are easier to work with in terms of file size.

[^3]: <https://www.linz.govt.nz/products-services/data/types-linz-data/elevation-data>
...
[LAWA](https://www.lawa.org.nz/explore-data/otago-region/river-quality/kakanui-river) tells us:
...
[LAWA](https://www.lawa.org.nz/explore-data/auckland-region/estuaries/whangateau) tells us:
...
And remember, if you like what you saw and want an STL file for your own group's catchment - just let me know and I'll see what I can do.

::: callout-tip
Want to print out these specific catchment models, or other models I've made? Head over to [Thingiverse](https://www.thingiverse.com/isaacbain/designs) to check out my designs.
